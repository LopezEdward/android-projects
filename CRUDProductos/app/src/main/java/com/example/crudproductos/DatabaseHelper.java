...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void insertarProducto(String nom, double precio, int stock, String url) {
    ...
    public List<Producto> obtenerProductos() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                listaProductos.add(new Producto(id, nombre, precio, stock, url));
    ...
    public int actualizarProducto(int id, String nom, double precio, int stock, String url) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
